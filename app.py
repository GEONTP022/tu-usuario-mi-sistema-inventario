...
# AQUÍ ESTÁ EL TRUCO: initial_sidebar_state="expanded" obliga a que inicie abierta
...
# ==============================================================================
# 3. CSS MAESTRO (LIMPIO Y BARRA LATERAL FIJA)
# ==============================================================================
st.markdown("""
    <style>
    /* 1. FIJAR BARRA LATERAL (OCULTAR EL BOTÓN DE CERRAR/X) */
    [data-testid="stSidebarCollapsedControl"] {
        display: none !important;
    }
    
    /* 2. ESTILOS DE LA APP (FONDO BLANCO LIMPIO) */
    ...
    /* Textos y Etiquetas */
    div[data-testid="stWidgetLabel"] p, label, h1, h2, h3, .stDialog p, .stDialog label, div[role="dialog"] p, .stMetricLabel { color: #000000 !important; -webkit-text-fill-color: #000000 !important; font-weight: 700 !important; }
    ...
    /* Estilo para inputs bloqueados (Disabled) */
    input:disabled { background-color: #e9ecef !important; color: #555555 !important; -webkit-text-fill-color: #555555 !important; border: 1px solid #ccc !important; }
    ...
    with c2:
        with st.container(border=True):
            ...
            with st.form("login_form"):
                ...
                # Botón submit permite entrar con ENTER
...
def modal_gestion(producto):
    ...
    with tab_salida:
        ...
        # Sin st.form para evitar Enter accidental
    ...
    if seleccion_str != "Seleccionar":
        ...
        if prod_data:
            with st.container(border=True):
                ...
                # --- EDICIÓN BLOQUEADA ---
                # Campos deshabilitados (disabled=True) y en gris
                    ...
                    try:
                        with st.spinner('Guardando cambios...'):
                            ...
                            datos_update = { 
                                ...
                                "imagen_url": new_img
                                # NO actualizamos los campos bloqueados
                            }
